...
live2d_settings['modelRandMode']        = false;     // 模型切换，可选 'rand'(随机), 'switch'(顺序)
live2d_settings['modelTexturesRandMode']= false;       // 材质切换，可选 'rand'(随机), 'switch'(顺序)
...
live2d_settings['waifuEdgeSide']        = 'left:40';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
live2d_settings['aboutPageUrl']         = 'http://www.rainerc.com/post/';   // 关于页地址, '{URL 网址}'
